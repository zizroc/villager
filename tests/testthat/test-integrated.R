...
test_that("models can add winiks each day", {
  ...
  population_model <- function(current_state, previous_state, model_data, winik_mgr, resource_mgr) {
    new_winik <- winik$new()
...
test_that("models can add and change resource quantities", {
  ...
  deterministic_crop_stock_model <- function(current_state, previous_state, model_data, winik_mgr, resource_mgr) {
...
test_that("models can change resoources based on information from the winik_manager", {
  ...
  crop_stock_model <- function(current_state, previous_state, model_data, winik_mgr, resource_mgr) {
...
test_that("winiks profession can change based on age", {
  initial_condition <- function(current_state, model_data, winik_manager, resource_mgr) {
    # 40 years old male
  ...
  winik_model <- function(current_state, previous_state, model_data, winik_mgr, resource_mgr) {
